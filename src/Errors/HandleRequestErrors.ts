...
import { isHttpError } from "./HttpException";
import { INTERNAL_SERVER_ERROR } from "../Resources/constants/status-codes";
import { logger } from "../Resources/logger/index";
...
const handleRequestError = (
  ...
  _logger.error(parsedError.message, {
    ...parsedError,
    requestUrl,
  });
